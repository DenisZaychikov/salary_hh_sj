...
if __name__ == '__main__':
    ...
    for prog_lang_vacancy in PROGRAMMING_LANG_VACANCIES:
        ...
        for vacancy in common_vacancies_hh_data:
            salary_from_hh = vacancy['salary']['from']
            salary_to_hh = vacancy['salary']['to']
            total_salary_hh += predict_rub_salary(salary_from_hh, salary_to_hh)
        ...
        for vacancy in common_vacancies_sj_data:
            salary_from_sj = vacancy['payment_from']
            salary_to_sj = vacancy['payment_to']
            total_salary_sj += predict_rub_salary(salary_from_sj, salary_to_sj)
